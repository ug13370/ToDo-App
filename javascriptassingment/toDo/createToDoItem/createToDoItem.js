...
function init(){
    ...
    if(localStorage.getItem("activeSessionId") === "null"){
        ...
        if(editMode)
            document.getElementById("toDoImageDisplay").src =   localStorage.getItem("toDoImage"+taskIdentifier);
    }
}
init();
...
function createToDo(){
    ...
    if(newTask.task === ""){
        ...
        reader.addEventListener("load",function(){
            localStorage.setItem("toDoImage"+newTask.taskIdentifier,reader.result);
            document.getElementById("toDoImageDisplay").src=localStorage.getItem("toDoImage"+newTask.taskIdentifier);
        },false)
