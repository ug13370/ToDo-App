...
function init(){
    ...
    //     let emailPresence=[];
    //     localStorage.setItem("emailPresence",JSON.stringify(emailPresence));
    // }

    if(localStorage.getItem("emailPresence")===null){
        let emailPresence=[];
        localStorage.setItem("emailPresence",JSON.stringify(emailPresence));
    }
}
...
const validateEmail = (email) => {
    ...
    if(isSignup){
        let emailPresence = JSON.parse(localStorage.getItem("emailPresence"));
...
function validateSignupForm(){
    ...
    if(!validateEmail(email)){
        ...
        console.log( (localStorage.getItem(sessionID)) , (localStorage.getItem("activeSessionId")) );
