...
let sessionValueStringified     =   sessionStorage.getItem(sessionId);
...
function init(){
    ...
    document.getElementById("profilePhoto").src         =   sessionStorage.getItem("profileImage"+sessionId);
...
function saveProfile(){
    ...
    sessionStorage.setItem(sessionId,JSON.stringify(sessionValueObject));
    console.log( JSON.parse(sessionStorage.getItem(sessionId)) , (sessionStorage.getItem("activeSessionId")) );
